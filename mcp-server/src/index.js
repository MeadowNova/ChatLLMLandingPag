...
server.tool("playwright-get-title", "Fetches the title of a web page using Playwright.", { url: zod_1.z.string().url().describe("URL of the page to fetch title from") }, (_a) => __awaiter(void 0, [_a], void 0, function* ({ url }) {
    const { chromium } = yield Promise.resolve().then(() => __importStar(require("playwright")));
